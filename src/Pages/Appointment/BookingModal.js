...
const BookingModal = ({ treatment, date, setTreatment, refetch }) => {
    ...
    const handleBooking = event => {
        ...
        fetch('https://ancient-anchorage-27912.herokuapp.com/booking', {
            method: 'POST',
            headers: {
            ...
            .then(data => {
                if (data.success) {
                    toast.success(`Successfully Booked, ${formattedDate} at ${slot}`, {
                        position: "top-center",
                        autoClose: 5000,
                    ...
                    toast.error(`You already Booked, ${data.booking?.date} at ${data.booking?.slot}`, {
                        position: "top-center",
                        autoClose: 5000,
                        hideProgressBar: false,
                        closeOnClick: true,
            ...
            <div className="modal modal-bottom sm:modal-middle">
                <div className="modal-box">
                    ...
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-3 justify-items-center mt-3'>
                        ...
                        <input type="text" name='phone' placeholder="Phone Nubmer" className="input input-bordered w-full max-w-xs" />
